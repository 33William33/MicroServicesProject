...
public class PostgresDAO {
    ...
    public void userregister(String name, String email, String password) throws SQLException {
        String query = "INSERT INTO users (email, password, prefer_name, rides, isDriver, availableCoupons, redeemedCoupons) VALUES ('%s', %s, '%s', 0, false, '{}', '{}')";
